                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="role" name="role" placeholder="Unit Role"
                                aria-label="Username" aria-describedby="basic-addon2">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="space" name="space" placeholder="Unit Space"
                                aria-label="Username" aria-describedby="basic-addon2">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="type" name="type" placeholder="Unit Type"
