...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$sql="INSERT INTO `articles`(`id`, `entitle`, `artitle`,
     `cover`, `encontent`, `arcontent`, `proid`) 
     VALUES (null,'$entitle','$artitle','$img','$encontent','$arcontent','$proid')";
    if(mysqli_query($connection,$sql)) {
        $msg= "Added";
        header('Location:manage-news.php?pro='.$_GET[pro]);
...
<div class="item form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Article Image <span class="required">*</span></label>
    <div class="col-md-6 col-sm-6 col-xs-12">
