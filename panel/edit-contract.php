...
$q="SELECT * FROM `units` WHERE `unitNum`='$value' AND `project`='$proId'";
    $qrun=mysqli_query($connection,$q);
    while($rows=mysqli_fetch_array($qrun)){
 	...
 	<div class="">
    	...
    	<div class="row">
        	<div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
<form class="form-horizontal form-label-left" novalidate  action="contract1.php"  method="post" target="_blank">
