                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="ادخل البريد الاليكترونى"
                    ...
                    <div class="col-12">
                        <div class="input-group mb-3">
                            ...
                            <textarea class="form-control" rows="4" name="msg" id="message" placeholder="ادخل رسالتك" cols="5"
                    ...
                    <div class="col-md-3">
                        <input id="submit" type="submit" class="form-control" name="submit" value="أطلب الان">
                    </div>
                </div>
            </form>
        </div>
